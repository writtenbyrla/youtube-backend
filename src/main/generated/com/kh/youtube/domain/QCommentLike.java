...
public class QCommentLike extends EntityPathBase<CommentLike> {
    ...
    public final QVideoComment videoComment;
    ...
    public QCommentLike(Class<? extends CommentLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.videoComment = inits.isInitialized("videoComment") ? new QVideoComment(forProperty("videoComment"), inits.get("videoComment")) : null;
    }
